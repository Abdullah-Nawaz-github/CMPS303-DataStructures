...
public class Test {
	public static void main(String args[]) {
		...
		myLinkedList.addLast(new Student(0, "Student3"));
		myLinkedList.addFirst(new Student(1, "Student4"));
...
//		System.out.println("myLinkedList.size(): " + myLinkedList.getCount());
//		myLinkedList.split().display();;
//		myLinkedList.display();
//		System.out.println("myLinkedList.size(): " + myLinkedList.getCount());
